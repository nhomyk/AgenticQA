...
- generic [ref=e1]:
  ...
  - textbox "JMeter-like performance results will appear here" [ref=e12]: "Performance Results (simulated JMeter summary) Total Requests: 2 Failed Requests: 0 Resource Count: 1 Avg Response Time (ms): 22 Page Load Time (ms): 72 Throughput (req/sec): 27.78 Top Resources: 1. https://example.com/favicon.ico — 22ms (other)"
