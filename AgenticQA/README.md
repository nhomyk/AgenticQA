...
[![2178+ Tests](https://img.shields.io/badge/tests-2178%2B-brightgreen.svg)](https://github.com/nhomyk/AgenticQA/actions)
...
| **Testing** | Pytest (2178+ unit/integration tests, 6 e2e pipeline tests) |
| **Language** | Python 3.8+ |
...
├── tests/                       # 2178+ tests — unit, integration, e2e pipeline, preflight
