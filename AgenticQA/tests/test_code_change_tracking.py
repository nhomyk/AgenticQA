...
class TestCodeChangeTracker:
    ...
    def test_end_change_improvement(self, change_tracker, test_before_data, test_after_data_improved):
    ...
    def test_end_change_degradation(self, change_tracker, test_before_data, test_after_data_degraded):
...
class TestDeploymentSafety:
    ...
    def test_safe_when_all_improved(self, change_tracker, test_before_data, test_after_data_improved):
...
class TestChangeHistoryAnalyzer:
    ...
    def test_statistics_generation(self, change_tracker, test_before_data, test_after_data_improved, test_after_data_degraded):
